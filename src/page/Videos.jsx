...
const Videos = () => {
  return (
    <div className='mb-4 max-w-13xl px-2 md:px-6 mx-auto'>
        <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className=" md:col-span-2 flex flex-col items-center justify-center">
                {videoData.map((video)=> (
            <div className="video-card max-w-4xl w-full bg-slate-100 mt-6 py-3 shadow-lg rounded-xl ">
                <div className=" flex items-center justify-between">
                    ...
                    <img className='max-w-5 mr-3' src={Images.Dot} alt="" />
                </div>
